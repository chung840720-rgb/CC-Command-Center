        ...
        <div className="card-soft p-6 lg:col-span-2">
          ...
          <ResponsiveContainer width="100%" height={260}>
            <BarChart data={data.monthlyTrend} margin={{ top: 10, right: 6, left: -16, bottom: 0 }}>
              ...
              <Bar dataKey="y2026" fill="hsl(188 65% 50%)" radius={[6, 6, 0, 0]} barSize={14} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {['momo', 'shopee', 'shopline'].map((id) => {
            ...
            const colors = { momo: '#ef4444', shopee: '#f97316', shopline: 'hsl(188 65% 50%)' } as const;
...
function AdEffectCard({ data }: { data: any }) {
  ...
  const BAR = { red: 'bg-red-400', orange: 'bg-orange-400', cyan: 'bg-cyan-400' };
  const DOT = { red: 'bg-red-500', orange: 'bg-orange-500', cyan: 'bg-cyan-500' };
